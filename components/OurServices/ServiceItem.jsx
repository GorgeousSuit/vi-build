...
const margin = index === 1 ? "mt-[60px]" : index === 2 ? "mt-[120px]" : index === 3 ? "mt-[-80px]" : index === 4 ? "mt-[-40px]" : "mt-[20px]"
    ...
    return (
        <div className={`p-[50px] max-w-[415px] max-[1400px]:w-[29.64vw] w min-[1305px]:w-[31.8vw] h-[330px] border-[2px] border-secondary1 rounded-[16px] text-left flex flex-col justify-center ${margin} max-lg:mt-[20px] mx-[10px]`}>
